...
func main() {
	...
	r.Handle("/v1/project/list",		genReqHandler(handleProjectList)).Methods("POST")
	r.Handle("/v1/project/del",		genReqHandler(handleProjectDel)).Methods("POST")
	r.Handle("/v1/function/add",		genReqHandler(handleFunctionAdd)).Methods("POST")
	r.Handle("/v1/function/update",		genReqHandler(handleFunctionUpdate)).Methods("POST")
	r.Handle("/v1/function/remove",		genReqHandler(handleFunctionRemove)).Methods("POST")
	r.Handle("/v1/function/run",		genReqHandler(handleFunctionRun)).Methods("POST")
	r.Handle("/v1/function/list",		genReqHandler(handleFunctionList)).Methods("POST")
	r.Handle("/v1/function/info",		genReqHandler(handleFunctionInfo)).Methods("POST")
	r.Handle("/v1/function/stats",		genReqHandler(handleFunctionStats)).Methods("POST")
	r.Handle("/v1/function/code",		genReqHandler(handleFunctionCode)).Methods("POST")
	r.Handle("/v1/function/logs",		genReqHandler(handleFunctionLogs)).Methods("POST")
	r.Handle("/v1/function/state",		genReqHandler(handleFunctionState)).Methods("POST")
	r.Handle("/v1/function/wait",		genReqHandler(handleFunctionWait)).Methods("POST")
	r.Handle("/v1/mware/add",		genReqHandler(handleMwareAdd)).Methods("POST")
	r.Handle("/v1/mware/info",		genReqHandler(handleMwareInfo)).Methods("POST")
	r.Handle("/v1/mware/list",		genReqHandler(handleMwareList)).Methods("POST")
	r.Handle("/v1/mware/remove",		genReqHandler(handleMwareRemove)).Methods("POST")
	r.Handle("/v1/mware/access/s3",		genReqHandler(handleMwareS3Access)).Methods("POST")

	r.Handle("/v1/info/langs",		genReqHandler(handleLanguages)).Methods("POST")
	r.Handle("/v1/info/mwares",		genReqHandler(handleMwareTypes)).Methods("POST")

	r.HandleFunc("/call/{fnid}",			handleFunctionCall).Methods("POST")
