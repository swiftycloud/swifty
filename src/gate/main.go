...
func getHandlers() http.Handler {
	...
	r.Handle("/v1/packages",		genReqHandler(handlePackages)).Methods("GET", "POST", "OPTIONS")
	r.Handle("/v1/packages/{pkgid}",	genReqHandler(handlePackage)).Methods("GET", "DELETE", "OPTIONS")
